import type { VehicleJourneysDirectionsV3 } from "../../model/v3/vehicleJourneysDirections.ts";
...
export const getVehicleJourneysDirectionsV3 = async (networkID: number, lineID: string, realtime: boolean = true, now: boolean = true, useDevInstance = false): Promise<VehicleJourneysDirectionsV3> => {
