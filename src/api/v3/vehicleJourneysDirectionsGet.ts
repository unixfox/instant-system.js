import { VehicleJourneysDirectionsV3 } from "../../model/v3/vehicleJourneysDirections";
import { DEV_BASE_URL, PROD_BASE_URL, V3_GET_VEHICLEJOURNEYS_DIRECTIONS } from "../../utils/endpoints";
