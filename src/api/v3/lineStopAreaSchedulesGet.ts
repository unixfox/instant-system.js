import { LineStopAreaSchedules } from "../../model/v3/stopAreaSchedules.ts";
...
export const getLineStopAreaSchedulesV3 = async (networkID: number, lineID:string, stopAreaID: string, useDevInstance=false): Promise<LineStopAreaSchedules> => {
  ...
  return data as LineStopAreaSchedules;
};